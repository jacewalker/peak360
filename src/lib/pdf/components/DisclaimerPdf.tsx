...
export function DisclaimerPdf() {
  return (
    ...
    >
      <Text style={{ fontSize: 8, fontFamily: FONT.sans, fontWeight: WEIGHT.semibold, color: COLORS.textSecondary, marginBottom: 3 }}>
        Medical Disclaimer
      </Text>
      <Text style={{ fontSize: 7, fontFamily: FONT.sans, fontWeight: WEIGHT.regular, color: COLORS.textSecondary, lineHeight: 1.5 }}>
      ...
      <Text style={{ fontSize: 7, fontFamily: FONT.sans, fontWeight: WEIGHT.regular, color: COLORS.textMuted, marginTop: 3 }}>
