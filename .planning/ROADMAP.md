...
Plans:
- [x] 04-01-PLAN.md -- Data encryption at rest with AES-256-GCM (SECU-01)
- [x] 04-02-PLAN.md -- Automated SQLite backups (SECU-03)
- [x] 04-03-PLAN.md -- Audit logging with admin browser UI (SECU-02)
