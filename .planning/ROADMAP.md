...
- [x] 12-05-PLAN.md - Verification: integration test (createMarker -> getReportMarkers -> markerToPillar), HUMAN-UAT.md happy-path + negative tests (Apolipoprotein B end-to-end add -> Section 11 modal -> PDF)
